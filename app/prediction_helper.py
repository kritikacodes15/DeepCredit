...
def prepare_input(age, income, loan_amount, loan_tenure_months, avg_dpd_per_delinquency,
    ...
    delinquent_to_total_loan_ratio = delinquency_ratio
    avg_dpd = avg_dpd_per_delinquency
    ...
    input_data = {
        ...
        'delinquent_to_total_loan_ratio': delinquent_to_total_loan_ratio,
        'avg_dpd': avg_dpd,
    ...
    # Check for missing columns before scaling
    missing_cols = set(cols_to_scale) - set(df.columns)
    if missing_cols:
